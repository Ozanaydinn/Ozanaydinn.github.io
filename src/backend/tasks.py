...
def analyze_hand(image_data, session_id, email):
...
def analyze_head(image_data, session_id, email, timestamp):
...
def analyze_object(image_data, session_id, email, timestamp):
